...
// bot behavior
const FString FAIE_Asset_Paths::BotHealthBehavior = FString("BehaviorTree'/Game/AI_Example/Blueprints/AI/StatBehaviors/Health_BT.Health_BT'");
const FString FAIE_Asset_Paths::BotStaminaBehavior = FString("BehaviorTree'/Game/AI_Example/Blueprints/AI/StatBehaviors/Stamina_BT.Stamina_BT'");
// Food items
